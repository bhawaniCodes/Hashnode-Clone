...
const userBlog = [
    {
        ...
        body: "Introduction Hello everyone, welcome back! today I want to talk about a very important topic: how to solve problems?. Learning how to solve problems i…",
        email: "Avneesh Agarwal",
        like: "50",
        comment: "2",
        createdAt: "Nov 7, 2021",
        title: "Programmers Guide to Solving Computational Problems",
        subTitle: "blog.garybricks.com",
        coverUrl:
            "https://blog.garybricks.com/_next/image?url=https%3A%2F%2Fcdn.hashnode.com%2Fres%2Fhashnode%2Fimage%2Fupload%2Fv1636227978922%2FE9sAOrxPQ.png%3Fw%3D1600%26h%3D840%26fit%3Dcrop%26crop%3Dentropy%26auto%3Dcompress%2Cformat%26format%3Dwebp&w=1920&q=75",
    },
];*/
function CenterCard() {
    ...
    async function getBlogs() {
        ...
        const data = await axios.get(`${commonUrl}/blogs`);

        setUserBlog(data.data.reverse());
    }
    ...
    return (
        <>
            {userBlog.map((e) => {
                ...
                return (
                    <HeadFlex key={e._id} onClick={() => GotoBlog(e._id)}>
                        <DataFlexBox key={e._id}>
                            <img
                                src={
                                    e.avatar ||
                        ...
                        <FlexBox>
                            ...
                            <HeadFlexSide>
                                ...
                                />
                                <SetImg>
                                    <TransperentButton></TransperentButton>
                                </SetImg>
                            </HeadFlexSide>
                        </FlexBox>
                    </HeadFlex>

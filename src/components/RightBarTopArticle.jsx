...
border-radius: 50%;
`
const WhileDiv = styled.div`
text-align:left;
`
const userBlog = [
    {
        id: uuid(),
        image:"https://cdn.hashnode.com/res/hashnode/image/upload/v1620419181276/oA1ZQbUUo.png?w=500&h=500&fit=crop&crop=entropy&auto=compress",
    ...
    {
        id: uuid(),
        image:"https://cdn.hashnode.com/res/hashnode/image/upload/v1635995048745/PmNr18l9g.png?w=500&h=500&fit=crop&crop=entropy&auto=compress",
        desc : "The Best Web3 Resources—Blockchain, Cryptocurrency, NFTs, DAOs, and the Metaverse",
        subname: "📽️",
        name: "Sam Sycamore",
        like: "139",
        comment: "7"
    ...
    {
        id: uuid(),
        image:"https://cdn.hashnode.com/res/hashnode/image/upload/v1602401666298/mU7IqqPmG.jpeg?w=500&h=500&fit=crop&crop=entropy&auto=compress",
        desc : "Introducing DevTunes FM: The Online Radio for Developers 📻🎶",
        subname: "📽️",
        name: "Madza",
        like: "127",
        comment: "22"
    ...
    {
        id: uuid(),
        image:"https://cdn.hashnode.com/res/hashnode/image/upload/v1633549757454/3MrlVlYkq.jpeg?w=500&h=500&fit=crop&crop=entropy&auto=compress",
        desc : "Programmers Guide to Solving Computational Problems",
        subname: "📽️",
        name: "Gary Vladimir Núñez López",
        like: "89",
        comment: "5"
    ...
    {
        id: uuid(),
        image:"https://cdn.hashnode.com/res/hashnode/image/upload/v1611415338868/vlQpbOJMr.png?w=500&h=500&fit=crop&crop=entropy&auto=compress",
        desc : "Becoming a Web3 developer",
        subname: "📽️",
        name: "Bode",
        like: "88",
        comment: "3"
            ...
            {userBlog.map((e) => {
                return (
                    <DataFlexBox key={e.id}>
                        <Image src={e.image} alt="avneesh" />
                        <div>
                            <WhileDiv>{e.desc}</WhileDiv>
